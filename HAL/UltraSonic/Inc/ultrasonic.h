...
#define TRIGGER2_PIN       		  PIN4_ID

#define ECHO2_PORT         		  PORTB_ID
#define ECHO2_PIN          		  PIN8_ID

#define UltraSonic_Channel2  	  channel_2
#define UltraSonic2_AF  		  AF10
