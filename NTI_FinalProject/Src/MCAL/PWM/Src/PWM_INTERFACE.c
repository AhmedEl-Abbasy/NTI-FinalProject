...
void  PWM_voidSetPinDirection(u8 Copy_u8tim, u8 Copy_u8ch){
	...
	case TIM1:
		if (Copy_u8ch == CH1)
		{
			DIOA_OTYPER_REG &= ~0x0000000F;
			DIOA_OTYPER_REG|= 0x0000000B; 	/* PA8: alternate func. output */
		...
		{
			DIOA_OTYPER_REG&=~0x000000F0;
			DIOA_OTYPER_REG|= 0x000000B0; 	/* PA9: alternate func. output */
		...
		{
			DIOA_OTYPER_REG&=~0x00000F00;
			DIOA_OTYPER_REG|= 0x00000B00; 	/* PA10: alternate func. output */
		...
		{
			DIOA_OTYPER_REG&=~0x0000F000;
			DIOA_OTYPER_REG|= 0x0000B000; 	/* PA11: alternate func. output */
	...
	case TIM2:
		...
		{
			DIOA_MODER_REG&=~0x0000000F;
			DIOA_MODER_REG|= 0x0000000B; 	/* PA0: alternate func. output */
		...
		{
			DIOA_MODER_REG&=~0x000000F0;
			DIOA_MODER_REG|= 0x000000B0; 	/* PA1: alternate func. output */
		...
		{
			DIOA_MODER_REG&=~0x00000F00;
			DIOA_MODER_REG|= 0x00000B00; 	/* PA2: alternate func. output */
		...
		{
			DIOA_MODER_REG&=~0x0000F000;
			DIOA_MODER_REG|= 0x0000B000; 	/* PA3: alternate func. output */
	...
	case TIM3:
		...
		{
			DIOA_MODER_REG&=~0x0F000000;
			DIOA_MODER_REG|= 0x0B000000; 	/* PA6: alternate func. output */
		...
		{
			DIOA_MODER_REG&=~0xF0000000;
			DIOA_MODER_REG|= 0xB0000000; 	/* PA7: alternate func. output */
		...
		{
			DIOA_MODER_REG&=~0x0000000F;
			DIOA_MODER_REG|= 0x0000000B; 	/* PB0: alternate func. output */
		...
		{
			DIOA_MODER_REG&=~0x000000F0;
			DIOA_MODER_REG|= 0x000000B0; 	/* PB1: alternate func. output */
	...
	case TIM4:
		...
		{
			DIOA_MODER_REG&=~0x0F000000;
			DIOA_MODER_REG|= 0x0B000000; 	/* PB6: alternate func. output */
		...
		{
			DIOA_MODER_REG&=~0xF0000000;
			DIOA_MODER_REG|= 0xB0000000; 	/* PB7: alternate func. output */
		...
		{
			DIOA_OTYPER_REG&=~0x0000000F;
			DIOA_OTYPER_REG|= 0x0000000B; 	/* PB8: alternate func. output */
		...
		{
			DIOA_OTYPER_REG&=~0x000000F0;
			DIOA_OTYPER_REG|= 0x000000B0; 	/* PB9: alternate func. output */
